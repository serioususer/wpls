...
Bei der Energy Detection müssen wir entscheiden ob das Signal in Klasse A (es wird dargestellt) oder in Klasse B befindet. Der Algorithmus geht jede Frequenz durch und überprüft ob der Treshold überschritten wird. Ist das Signal größer als der Grenzwert kommt das Signal in die Klasse A. Am Ende wird das Ergebnis dargestellt.
